    ...
    <div class="container-modern">
        ...
        <div class="header-section">
            <div class="header-top" style="display: flex; align-items: center; justify-content: space-between;">
                <div class="header-title" style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div>
                        <h1 class="page-title-modern" style="margin:0;">Edit Nilai Magang</h1>
                        <p class="page-subtitle-modern" style="margin:0;">Ubah data nilai magang siswa</p>
                    </div>
                </div>
                <div class="header-breadcrumbs">
                    <x-breadcrumbs :items="[
                        ...
                        ['label' => 'Edit Nilai', 'route' => 'admin.nilaipkl.edit', 'params' => $nilai->id],
                    ]" />
                </div>
            </div>
        ...
        <div class="data-card">
            <div class="card-header-clean">
                <h3 class="card-title-clean">Form Edit Nilai Magang</h3>
                <span class="form-subtitle">Ubah informasi penilaian Magang</span>
            </div>

            <div class="form-container-modern">
                <form action="{{ route('admin.nilaipkl.update', $nilai->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-grid">
                                <div class="form-group-modern full-width">
                                    ...
                                    <select name="no_magang" id="no_magang"
                                        ...
                                        @foreach($magang as $p)
                                            <option value="{{ $p->no_magang }}" {{ (old('no_magang', $nilai->no_magang) == $p->no_magang) ? 'selected' : '' }}>
                            ...
                            <div class="form-grid">
                                <div class="form-group-modern">
                                    ...
                                    <input type="number" name="nilai_pkl" id="nilai_pkl"
                                        ...
                                        value="{{ old('nilai_pkl', $nilai->nilai_akhir) }}" min="0" max="100" step="0.01"
                                ...
                                <div class="form-group-modern full-width">
                                    ...
                                    <textarea name="catatan" id="catatan" rows="4"
                                        ...
                                        placeholder="Tuliskan catatan evaluasi, kelebihan, kekurangan, atau saran...">{{ old('catatan', $nilai->catatan) }}</textarea>
                                    @error('catatan')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="purple-card">
                            <div class="form-group-modern full-width">
                                ...
                                @if($nilai->file_scan_nilai)
                                    <div class="mb-3">
                                        <strong>File saat ini:</strong>
                                        <a href="{{ asset('storage/scan_nilai_pkl/' . $nilai->file_scan_nilai) }}" target="_blank" class="text-primary">
                                            {{ $nilai->file_scan_nilai }}
                                        </a>
                                    </div>
                                @endif
                                ...
                                <div class="file-upload-modern">
                                    ...
                                    <label for="file_scan_nilai" class="file-label-modern">
                                        <i class="mdi mdi-cloud-upload"></i>
                                        <span>Pilih file baru atau drag & drop</span>
