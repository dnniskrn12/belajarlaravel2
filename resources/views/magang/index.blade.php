...
@section('content')
        ...
        <div class="header-section">
            <div class="header-top" style="display: flex; align-items: center; justify-content: space-between;">
                <div class="header-title" style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div>
                        ...
                        <p class="page-subtitle-modern" style="margin:0;">Kelola informasi magang</p>
                    </div>
                </div>
                <div class="header-breadcrumbs">
                    <x-breadcrumbs :items="[['label' => 'Dashboard', 'route' => 'admin.dashboard'], ['label' => 'Magang', 'route' => 'admin.magang.index'],]" />
                </div>
            </div>
            <div class="action-bar">
                ...
                <div class="action-buttons">
                    <a href="{{ route('admin.magang.create') }}" class="btn-add-modern bg-gradient-primary">
                                ...
                                <td>
                                    <div class="action-buttons-table">
                                        <button type="button" class="action-btn-table view" data-bs-toggle="modal"
                                            data-bs-target="#modalfoto{{ $item->no_magang}}" title="Lihat Foto">
                                            <i class="mdi mdi-eye"></i>
                                        </button>

                                        <a href="{{route('admin.magang.show', $item->id)}}" class="action-btn-table view"
                                            title="Detail">
                                            <i class="mdi mdi-account-details"></i>
                                        </a>

                                        <a href="{{ route('admin.magang.edit', $item->id) }}" class="action-btn-table edit"
                                            title="Edit">
    ...
    @foreach ($magang as $item)
        <div class="modal fade" id="modalfoto{{$item->no_magang}}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
                    <div class="modal-header"
                        style="background: linear-gradient(135deg, #d58df7, #a31dd8); color: white; border: none;">
                        <h5 class="modal-title" style="font-weight: 600;">
                            <i class="mdi mdi-account-circle me-2"></i>{{ $item->nama_siswa }}
                        </h5>
                    ...
                    <div class="modal-body text-center" style="padding: 32px;">
                        ...
                        <div style="margin-top: 16px;">
                            <h6 style="margin-bottom: 4px; font-weight: 600;">{{ $item->nama_siswa }}</h6>
                            <small style="color: #6b7280;">{{ $item->no_magang }}</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function () {
            ...
            $('.btn-delete').on('click', function () {
                ...
                Swal.fire({
                    ...
                    html: 'Yakin ingin menghapus data magang?<br><b>Data tidak bisa dikembalikan!</b>',
                    icon: 'warning',
