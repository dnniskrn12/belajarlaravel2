    ...
    <div class="container-modern">
        ...
        <div class="header-section">
            <div class="header-top" style="display: flex; align-items: center; justify-content: space-between;">
                <div class="header-title" style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div>
                        <h1 class="page-title-modern" style="margin:0;">Tambah Magang</h1>
                        <p class="page-subtitle-modern" style="margin:0;">Tambah data magang baru</p>
                    </div>
                </div>
                <div class="header-breadcrumbs">
                    <x-breadcrumbs :items="[
                        ...
                        ['label' => 'Tambah', 'route' => 'admin.magang.create'],
                    ]" />
                </div>
            </div>
        ...
        <div class="data-card">
            <div class="card-header-clean">
                <h3 class="card-title-clean">Form Data Magang</h3>
                <span class="form-subtitle">Lengkapi semua informasi magang</span>
            </div>

            <div class="form-container-modern">
                <form action="{{ route('admin.magang.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                            ...
                            <div class="form-grid">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="no_magang" id="no_magang"
                                        class="form-input-modern @error('no_magang') error @enderror"
                                        value="{{ old('no_magang') }}" placeholder="Masukkan nomor magang" required>
                                    @error('no_magang')
                            ...
                            <div class="form-grid">
                                <div class="form-group-modern">
                                    ...
                                    <select name="status_magang" id="status_magang"
                                        ...
                                        <option value="Aktif" {{ old('status_magang') == 'Aktif' ? 'selected' : '' }}>
                                            Aktif
                                        </option>
                                        <option value="Non Aktif" {{ old('status_magang') == 'Non Aktif' ? 'selected' : '' }}>Non Aktif</option>
                                    </select>
                                    @error('status_magang')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
