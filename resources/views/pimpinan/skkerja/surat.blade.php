...
<head>
    <meta charset="UTF-8" />
    <title>Surat Keputusan Kerja - {{ $sk->nama_pegawai }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-container">
        ...
        <div class="title">SURAT KEPUTUSAN KERJA</div>
        ...
        <div class="content">
            ...
            <div class="data-list">
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    <tr>
                        <td style="width: 180px; padding: 4px 8px; font-weight: bold;">Nama Pegawai</td>
                        <td style="padding: 4px 8px;">: {{ $sk->nama_pegawai }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 4px 8px; font-weight: bold;">Nomor Induk Pegawai</td>
                        <td style="padding: 4px 8px;">: {{ $sk->no_pegawai }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 4px 8px; font-weight: bold;">Jabatan</td>
                        <td style="padding: 4px 8px;">: {{ $sk->jabatan?->nama_jabatan }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 4px 8px; font-weight: bold;">Unit Kerja</td>
                        <td style="padding: 4px 8px;">: {{ $sk->unitkerja?->nama_unitkerja }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 4px 8px; font-weight: bold;">Lokasi Kerja</td>
                        <td style="padding: 4px 8px;">: {{ $sk->lokasi?->nama_lokasi }}</td>
                    </tr>
                </table>
            </div>


            <p>Kepada yang bersangkutan diberikan tugas dan tanggung jawab sesuai dengan jabatan yang telah ditetapkan
                dan wajib melaksanakan tugas sebaik-baiknya dengan penuh tanggung jawab.</p>

            <p>Keputusan ini mulai berlaku sejak tanggal ditetapkan
                {{ \Carbon\Carbon::parse($sk->tgl_sk)->format('d F Y') }}, dengan ketentuan apabila di kemudian hari
                terdapat kekeliruan dalam keputusan ini akan dilakukan perbaikan sebagaimana mestinya.</p>
