...
<head>
    <meta charset="UTF-8" />
    <title>Laporan Data SK Kerja</title>
    <style>
        body {
...
<body>
    ...
    <h1 style="text-decoration: underline">LAPORAN SK KERJA PEGAWAI</h1>
    <p class="subtitle">Daftar Surat Keterangan Kerja Pegawai</p>
