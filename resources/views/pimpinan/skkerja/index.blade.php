...
@section('content')
        ...
        <div class="header-section">
            <div class="header-top" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="header-breadcrumbs">
                    <x-breadcrumbs :items="[['label' => 'Dashboard', 'route' => 'pimpinan.dashboard'], ['label' => 'SK Kerja', 'route' => 'pimpinan.skkerja.index']]" />
                </div>
            </div>
            ...
            <div class="action-bar">
                ...
                <div class="action-buttons">
                    <a data-bs-toggle="modal" data-bs-target="#cetakLaporanSkKerjaModal"
                            ...
                            <tr class="sk-row"
                                ...
                                <td>
                                    <div class="action-buttons-table">
                                        <a data-bs-toggle="modal" data-bs-target="#cetakSkKerjaModal{{ $item->id}}"
    ...
    {{-- Modal Cetak Semua Laporan SK Kerja --}}
    <div style="page-break-after: always;">
        <div class="modal fade" id="cetakLaporanSkKerjaModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
                    <div class="modal-header"
                        style="background: linear-gradient(135deg, #3b82f6, #1e40af); color: white; border: none;">
                        <h5 class="modal-title" style="font-weight: 600;">
                            <i class="mdi mdi-printer me-2"></i>Cetak Semua Laporan SK Kerja
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            style="filter: brightness(0) invert(1);"></button>
                    </div>
                    <div class="modal-body" style="padding:0; height:80vh;">
                        <iframe src="{{ route('pimpinan.skkerja.cetak') }}"
    ...
    {{-- Modal Cetak Satu Laporan SK Kerja --}}
    @foreach ($sk as $item)
        <div class="modal fade" id="cetakSkKerjaModal{{ $item->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
                    <div class="modal-header"
                        style="background: linear-gradient(135deg, #3b82f6, #1e40af); color: white; border: none;">
                        <h5 class="modal-title" style="font-weight: 600;">
                            <i class="mdi mdi-printer me-2"></i>Cetak SK Kerja - {{ $item->nama_pegawai }}
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            style="filter: brightness(0) invert(1);"></button>
                    </div>
                    <div class="modal-body p-0" style="height: 80vh;">
                        <iframe src="{{ route('pimpinan.skkerja.cetakSatu', $item->id) }}"
                            style="width:100%; height:100%; border:none;"></iframe>
                    </div>
                </div>
            </div>
