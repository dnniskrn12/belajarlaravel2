    ...
    <div class="container-modern">
        ...
        <div class="header-section">
            <div class="header-top" style="display: flex; align-items: center; justify-content: space-between;">
                <div class="header-title" style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div>
                        <h1 class="page-title-modern" style="margin:0;">Tambah User</h1>
                        <p class="page-subtitle-modern" style="margin:0;">Tambah data user baru</p>
                    </div>
                </div>
            ...
            ['label' => 'Tambah', 'route' => 'superadmin.user.create'],
        ]" />
                </div>
            </div>
        ...
        <div class="data-card">
            ...
            <div class="form-container-modern">
                <form action="{{ route('superadmin.user.store') }}" method="POST" novalidate>
                    @csrf
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="form-input-modern @error('name') error @enderror" value="{{ old('name') }}"
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <select name="role_id" id="role_id"
                                        ...
                                        <option value="2" {{ old('role_id') == '2' ? 'selected' : '' }}>Superadmin</option>
